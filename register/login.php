            ...
            <div class="row m-0">
                <div class="col-lg-4 offset-lg-2">
                    <div class="text-center pb-5">
                        ...
                        <p class="p-1 m-0 font-ubuntu text-black-50">Login and enjoy addtional features</p>
                        <span class="font-ubuntu text-black-50">Create a new <a href="register.php">account</a></span>
                    </div>
                    <div class="upload-profile-image d-flex justify-content-center pb-5">
                        <div class="text-center">
                            <img src="<?php echo isset($user['profileImage']) ? $user['profileImage'] : './assets/profile/beard.png';?>" style="width: 200px; height: 200px;" class="img rounded-circle" alt="beard">
                        </div>
                    </div>
