                ...
                <div class="col-lg-4 offset-lg-2">
                    ...
                    <div class="upload-profile-image d-flex justify-content-center pb-5">
                        <div class="text-center">
                            ...
                            <img src="./assets/profile/beard.png" style="width: 200px; height: 200px;" class="img rounded-circle" alt="beard">
                    ...
                    <div class="d-flex justify-content-center">
                        <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                            ...
                            <div class="form-check form-check-inline">
                                <input type="checkbox" name="argreement" class="form-check-input" required>
                                <label for="agreement" class="form-check-label font-ubuntu text-black-50">
                                    I agree <a href="#">term, conditions, and policy</a>(*)
                                </label>
                            </div>
